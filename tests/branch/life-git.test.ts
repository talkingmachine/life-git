...
describe("Life Git housing branch", () => {
  ...
  test("schema contains the exact append-only table inventory", () => {
    ...
    expect(tables).toEqual([
      ...
      { name: "city_source_binding_heads" },
      { name: "city_source_binding_revisions" },
      { name: "city_source_versions" },
      ...
      { name: "official_source_recovery_attempts" },
      { name: "official_source_replacement_events" },
